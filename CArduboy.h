...
class Boxer
{
  ...
  // Constructor - creates a Boxer 
  // and initializes the member variables and state
  
  Boxer(int w, int h, int x, int y, const uint8_t *bmp, const uint8_t *msk)
  {
  width = w;
  height = h;
  posX = x;
...
public:
  ...
  void drawBitmapJ(int16_t x, int16_t y, const uint8_t *bitmap, int16_t w, int16_t h, uint16_t color);
  void drawBitmapK(int16_t x, int16_t y, const uint8_t *bitmap, int16_t w, int16_t h, uint16_t color);  
  void drawMaskedBitmap(int16_t x, int16_t y, const uint8_t *bitmap, const uint8_t *mask, int16_t w, int16_t h, uint16_t color);
  void drawMaskedBitmapBW(int16_t x, int16_t y, const uint8_t *bitmap, const uint8_t *mask, int16_t w, int16_t h, uint16_t color);
  ...
  ArduboyTunes2 tunes2;
  ArduboyAudio2 audio2;
